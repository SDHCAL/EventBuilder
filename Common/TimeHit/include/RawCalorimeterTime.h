...
// =========================================================================
#ifndef EVENT_RAWCALORIMETERTIME_H
#define EVENT_RAWCALORIMETERTIME_H 1
...
class RawCalorimeterTime ;
/**Vector of (pointers to) RawCalorimeterHits.*/
typedef std::vector<RawCalorimeterTime*> RawCalorimeterTimeVec ;
...
class RawCalorimeterTime : public LCObject {

public: 
    /// Destructor.
    virtual ~RawCalorimeterTime() { /* nop */; }


    /** Useful typedef for template programming with LCIO */
    typedef RawCalorimeterTime lcobject_type ;
